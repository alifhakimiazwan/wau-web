...
export function LeadMagnetPreview({
  ...
  // Get border radius based on block shape
  const getBorderRadius = () => {
    if (!designConfig) return "rounded-lg";
    switch (designConfig.blockShape) {
      case "square":
        return "rounded-none";
      case "rounded":
        return "rounded-lg";
  ...
  const inputBorderRadius =
    designConfig?.blockShape === "pill" ? "rounded-full" : borderRadius;

  // Get top border radius for thumbnail
